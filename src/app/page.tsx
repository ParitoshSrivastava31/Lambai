  ...
  return (
    <>
      ...
      <main className="flex w-full flex-col">
        ...
        <section className="relative flex min-h-[60vh] w-full flex-col items-center justify-center bg-void px-5 py-32 sm:px-8">
          <div
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <span className="mb-6 font-body text-[11px] uppercase tracking-widest text-gold">
              Start in 30 seconds
            </span>
            <h2 className="mb-12 font-display text-[clamp(48px,6vw,88px)] leading-[1.1] text-text-primary">
