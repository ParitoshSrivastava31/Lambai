  ...
  return (
    <section className="relative w-full overflow-hidden px-4 md:px-8 py-24 md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-6xl flex flex-col items-center">
        ...
        {/* Bento Grid */}
        {/* Bento Grid */}
        <div className="grid w-full grid-cols-12 gap-4 md:gap-6" style={{ gridTemplateRows: 'repeat(2, minmax(280px, auto))' }}>

          {/* Card 1: Precision Nutrition — narrow portrait, row 1 */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            className="col-span-12 md:col-span-3 relative flex flex-col justify-end overflow-hidden rounded-[24px] md:rounded-[32px] bg-white shadow-sm border border-border group min-h-[280px]"
          >
            <div
          ...
          {/* Card 2: Interactive Progress — medium, row 1 */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            custom={1}
            className="col-span-12 md:col-span-4 relative flex flex-col overflow-hidden rounded-[24px] md:rounded-[32px] bg-white/40 backdrop-blur-md p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 min-h-[280px]"
          >
          ...
          {/* Card 3: Predictive Analysis — tall, spans BOTH rows, right column */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            custom={2}
            className="col-span-12 md:col-span-5 md:row-span-2 relative items-start flex flex-col overflow-hidden rounded-[24px] md:rounded-[32px] bg-linear-to-br from-[#F8FAFC] to-[#EFF6FF] p-6 md:p-8 shadow-sm border border-blue-100 group min-h-[280px]"
          >
            <div
          ...
          {/* Card 4: 24/7 Expert Support — wide, row 2 left */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            custom={3}
            className="col-span-12 md:col-span-4 relative flex flex-col sm:flex-row items-center justify-between overflow-hidden rounded-[24px] md:rounded-[32px] bg-white p-6 md:p-8 shadow-sm border border-border min-h-[280px]"
          >
          ...
          {/* Card 5: Auto Reminder — row 2 middle */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            custom={4}
            className="col-span-12 md:col-span-3 relative flex items-center justify-center flex-col overflow-hidden rounded-[24px] md:rounded-[32px] bg-gold/5 p-6 shadow-sm border border-gold/10 min-h-[280px]"
          >
